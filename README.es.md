...
- **Las pruebas se ejecutan con el commit que modifica el código**; 1342 superadas por dos personas, con CI basado en rutas para las 1288 versiones herméticas.
