...
- Les tests sont associés au commit qui modifie le code — 699 tests réussis sur deux postes, avec une intégration continue basée sur les chemins pour les 690 tests hermétiques.
