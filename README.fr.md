...
- Les tests sont associés au commit qui modifie le code — 890 tests réussis sur deux postes, avec une intégration continue basée sur les chemins pour les 850 tests hermétiques.
