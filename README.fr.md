...
- **Les tests sont liés au commit qui modifie le code** — 1 376 tests réussis, évalués par deux personnes, avec une intégration continue basée sur les chemins pour les 1 319 tests hermétiques.
