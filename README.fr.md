...
- **Les tests sont liés au commit qui modifie le code** — 1266 tests réussis, avec des contrôles d'intégration basés sur les chemins pour les 1212 tests hermétiques.
