...
- **Les tests sont liés au commit qui modifie le code** — 1 346 tests réussis, évalués par deux personnes, avec des contrôles CI basés sur les chemins pour les 1 289 tests hermétiques.
