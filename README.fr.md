...
- Les tests sont associés au commit qui modifie le code — 684 tests réussis sur deux postes, avec une intégration continue basée sur les chemins pour les 675 tests hermétiques.
