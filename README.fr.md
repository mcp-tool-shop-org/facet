...
- **Les tests sont liés au commit qui modifie le code** — 1 338 tests réussis, évalués par deux personnes, avec des contrôles CI basés sur les chemins pour les 1 284 tests hermétiques.
