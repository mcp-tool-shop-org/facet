...
- Les tests sont associés au commit qui modifie le code — 808 tests réussis sur deux postes, avec une intégration continue basée sur les chemins pour les 768 tests hermétiques.
