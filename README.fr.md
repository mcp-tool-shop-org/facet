...
- **Les tests sont liés au commit qui modifie le code** — 1295 tests réussis, avec des contrôles d'intégration basés sur les chemins pour les 1241 tests hermétiques.
