...
cd facet
python -m pytest -m "not artifacts"   # the 1288 hermetic tests CI reproduces.
```

The full suite is 1342 tests. The 54 it deselects are the *artifacts* tier — they replay
...
Sixty-three experiments are in
