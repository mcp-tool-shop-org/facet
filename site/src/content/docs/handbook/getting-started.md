...
cd facet
python -m pytest -m "not artifacts"   # the 1284 hermetic tests CI reproduces.
```

The full suite is 1338 tests. The 54 it deselects are the *artifacts* tier — they replay
