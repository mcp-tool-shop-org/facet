...
cd facet
python -m pytest -m "not artifacts"   # the 1318 hermetic tests CI reproduces.
```

The full suite is 1375 tests. The 57 it deselects are the *artifacts* tier — they replay
