...
cd facet
python -m pytest -m "not artifacts"   # the 1128 hermetic tests CI reproduces
```

The full suite is 1174 tests. The 46 it deselects are the *artifacts* tier — they replay
