...
cd facet
python -m pytest -m "not artifacts"   # the 940 hermetic tests CI reproduces
```

The full suite is 985 tests. The 45 it deselects are the *artifacts* tier — they replay
