...
cd facet
python -m pytest -m "not artifacts"   # the 1181 hermetic tests CI reproduces.
```

The full suite is 1233 tests. The 52 it deselects are the *artifacts* tier — they replay
