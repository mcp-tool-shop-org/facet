...
cd facet
python -m pytest -m "not artifacts"   # the 851 hermetic tests CI reproduces
```

The full suite is 891 tests. The 40 it deselects are the *artifacts* tier — they replay
