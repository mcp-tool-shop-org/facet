...
cd facet
python -m pytest -m "not artifacts"   # the 850 hermetic tests CI reproduces
```

The full suite is 890 tests. The 40 it deselects are the *artifacts* tier — they replay
