...
cd facet
python -m pytest -m "not artifacts"   # the 1289 hermetic tests CI reproduces.
```

The full suite is 1346 tests. The 57 it deselects are the *artifacts* tier — they replay
...
Seventy-one experiments are in
