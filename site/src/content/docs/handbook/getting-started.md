...
cd facet
python -m pytest -m "not artifacts"   # the 1135 hermetic tests CI reproduces
```

The full suite is 1182 tests. The 47 it deselects are the *artifacts* tier — they replay
