...
cd facet
python -m pytest -m "not artifacts"   # the 1023 hermetic tests CI reproduces
```

The full suite is 1068 tests. The 45 it deselects are the *artifacts* tier — they replay
...
Thirty-seven experiments are in
