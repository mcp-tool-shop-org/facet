...
cd facet
python -m pytest -m "not artifacts"   # the 877 hermetic tests CI reproduces
```

The full suite is 917 tests. The 40 it deselects are the *artifacts* tier — they replay
