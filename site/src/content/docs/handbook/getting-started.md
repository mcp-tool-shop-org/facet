...
cd facet
python -m pytest -m "not artifacts"   # the 753 hermetic tests CI reproduces
```

The full suite is 782 tests. The 29 it deselects are the *artifacts* tier — they replay
