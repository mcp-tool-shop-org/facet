...
cd facet
python -m pytest -m "not artifacts"   # the 1285 hermetic tests CI reproduces.
```

The full suite is 1339 tests. The 54 it deselects are the *artifacts* tier — they replay
...
Fifty-seven experiments are in
