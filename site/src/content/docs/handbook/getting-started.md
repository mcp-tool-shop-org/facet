...
cd facet
python -m pytest -m "not artifacts"   # the 995 hermetic tests CI reproduces
```

The full suite is 1040 tests. The 45 it deselects are the *artifacts* tier — they replay
