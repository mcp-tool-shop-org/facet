...
cd facet
python -m pytest -m "not artifacts"   # the 1319 hermetic tests CI reproduces.
```

The full suite is 1376 tests. The 57 it deselects are the *artifacts* tier — they replay
