...
cd facet
python -m pytest -m "not artifacts"   # the 1042 hermetic tests CI reproduces
```

The full suite is 1087 tests. The 45 it deselects are the *artifacts* tier — they replay
