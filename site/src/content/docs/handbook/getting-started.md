...
cd facet
python -m pytest -m "not artifacts"   # the 1027 hermetic tests CI reproduces
```

The full suite is 1072 tests. The 45 it deselects are the *artifacts* tier — they replay
...
Thirty-nine experiments are in
