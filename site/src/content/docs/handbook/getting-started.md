...
cd facet
python -m pytest -m "not artifacts"   # the 761 hermetic tests CI reproduces
```

The full suite is 790 tests. The 29 it deselects are the *artifacts* tier — they replay
...
Twenty-eight experiments are in
