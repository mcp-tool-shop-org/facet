...
cd facet
python -m pytest -m "not artifacts"   # the 1173 hermetic tests CI reproduces
```

The full suite is 1223 tests. The 50 it deselects are the *artifacts* tier — they replay
