...
cd facet
python -m pytest -m "not artifacts"   # the 923 hermetic tests CI reproduces
```

The full suite is 967 tests. The 44 it deselects are the *artifacts* tier — they replay
