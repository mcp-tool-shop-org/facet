...
cd facet
python -m pytest -m "not artifacts"   # the 1062 hermetic tests CI reproduces
```

The full suite is 1107 tests. The 45 it deselects are the *artifacts* tier — they replay
