---
title: "The facet handbook"
description: "A styled 2D concept goes in; a textured 3D asset comes out. The route, stage by stage, with every claim traced to a numbered experiment."
sidebar:
  order: 0
---

<!-- GENERATED by docs/handbook/sync_to_site.py from docs/handbook/index.md.
...
written before [E14 Ruling 32](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md) accepted the finished
...
This handbook is the guide. [The README](https://github.com/mcp-tool-shop-org/facet/blob/main/README.md) is the measured state of every
tool, and [docs/experiments](https://github.com/mcp-tool-shop-org/facet/tree/main/docs/experiments) is the evidence — every claim here traces to
...
([E01](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E01-facial-structure-ceiling.md)).
...
([E12 Ruling 2](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)) because its head reconstructs with
...
46 exterior cameras ([E05](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E05-paint-more-surface.md)).
...
- **⚠ Corrected in place, 2026-08-05 — the sentence below was written before E04 and
  ...
  subject, never inherited ([the profile design](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/profiles-design.md),
...
([E12's kickoff](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-executor-kickoff.md) is the worked current example):
...
3. **The profile is drafted** (`profiles/<subject>.json`): measured values with their
   ...
   expressed mechanically. See [Subject profiles](../profiles/).
...
The dense-turnaround exporter ([E11](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E11-ruling.md)) turns an accepted
