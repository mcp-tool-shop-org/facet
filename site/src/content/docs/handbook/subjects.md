---
title: "The subjects"
description: "Four subject classes through the route — character, galleon, dragon, longsword — with their numbers and, crucially, their denominators."
sidebar:
  order: 2
---

<!-- GENERATED by docs/handbook/sync_to_site.py from docs/handbook/subjects.md.
...
> [known-defects.md](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/known-defects.md) carried the defect, and neither noted they were one
...
> ([E56](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E56-wrong-material-check-report.md)). Acceptance here is a ruling on
...
- **Record:** [E08-ruling-gate0.md](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E08-ruling-gate0.md), 35 amendments.
  Fixture: [canon/W3-IDENTITY.md](https://github.com/mcp-tool-shop-org/facet/blob/main/canon/W3-IDENTITY.md) — a test fixture, not a
...
- **Record:** [E04-ruling.md](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E04-ruling.md), 29 rulings + the close
  (*the count read "28" until E15's verifier counted the record itself — Ruling 29 is
  the asset-2 blob-bound halt*).
  Fixture: [canon/GALLEON-IDENTITY.md](https://github.com/mcp-tool-shop-org/facet/blob/main/canon/GALLEON-IDENTITY.md) (thirteen
...
- **Record:** [E12-ruling.md](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md), Rulings 1–30 + the
  Gate-1 acceptance; [Gate 0 report](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-gate0-report.md). Fixture:
  [canon/DRAGON-IDENTITY.md](https://github.com/mcp-tool-shop-org/facet/blob/main/canon/DRAGON-IDENTITY.md) (eleven D-elements;
...
- The first styled pair (0 credits) was **rejected at the Director's eye** — and the
  ...
  ([E12 Ruling 10](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)): the beast runs ultra-realistic
  ...
  [style-registers.md](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/style-registers.md).
...
- **Handoff 5 ran all three at 0 credits**
  ([report](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-handoff5-report.md)): **the mesh HAS a tongue** —
  ...
  **D9/D11 swap surfaces with scale** — wine took the cavity at pair scale, slate
  ...
  ([Ruling 12](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)): canon corrected in place (D2
...
- **Handoff 6 ran at 0 credits and the bone reads leave at the worst seed**
  ([Ruling 13](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)): same seed, same control, prompt
  ...
  direction.
- **THE PAIR IS ACCEPTED** ([Ruling 14](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md),
...
- **The bands are RULED against the accepted pair**
  ([Ruling 15](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)): warm-olive **85.4–147.3**
...
- **The gate's pair-validation halted itself before gating anything**
  ([Ruling 16](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)): the pre-registered third branch
...
- **The eight twins ran at 0 credits** ([Ruling 17](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)):
  ...
  17–20.
- **The exemplar arc** ([Rulings 20–23](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)): the
...
- **Stage 1 is BANKED and the crop pass ruled**
  ([Rulings 24–25](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)): **A0 = 1,430,687 styled texels =
  ...
  **thin_extent 0.005 global on the artifact criterion** (the arc's last UNDECIDED
  ...
  ([Ruling 26](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md)) — **a ruling that decides values pays
...
- **ACCEPTED at Gate 1** (2026-08-07, "Fantastic!! This is really good!" —
  [Ruling 28](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E12-ruling.md), on the GLB at the Director's own
  ...
  [E15 context index](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E15-context-index-kickoff.md), and the E14 arc.
...
- **GATE 1: ACCEPTED** ("Fantastic! I accept", ruled on `longsword_hero.glb` at the
  Director's own zoom — [Ruling 32](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)). The route's
...
- **Record:** [E14-ruling.md](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md), Rulings 1–35;
  [Gate 0 report](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-gate0-report.md);
  [handoff-2 report](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-handoff2-report.md) +
  [Task-1 sweep](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-task1-sweep.md);
  [handoff-9 report](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-handoff9-report.md) (finalize/pack/Gate-1
  staging). Fixture:
  [canon/LONGSWORD-IDENTITY.md](https://github.com/mcp-tool-shop-org/facet/blob/main/canon/LONGSWORD-IDENTITY.md) (five L-elements —
...
- Gate 0's class headlines: **the route's first portrait subject**
  ...
  [E14 Ruling 3](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md), CLAUDE.md constraint extended);
...
- **Measured at handoff 2** (the pass before any generation): pre-registered reach
  ...
  cross-subject class reading ([E14 Ruling 9](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md): the
...
- **The styled target pair is ACCEPTED** (Director, 2026-08-07: *"I agree with
  ...
  [E14 Ruling 16](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)). Task 4 ran at 0 credits: view 0
...
- **Named and parked at his timing: THE ACTIVATED STATE** (Ruling 16c) — a second
  ...
  is now named** ([Ruling 35](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md), 2026-08-08): it opens
...
- **The bands are RULED** ([Ruling 17](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)): floor 12.0 —
...
- **The twin set measured its seed** (handoff 3 Task 2 → [Ruling 18](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)):
...
- **The re-roll pass resolved to the clean exit** (handoff 4 →
  [Ruling 19](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)): all four diagonals landed iron at
...
- **The Director's eye overturned an acceptance**
  ([Ruling 20](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md), 2026-08-08): view 6's re-roll
...
- **Stage 1 ran as SEVEN twins** (the session launched before Ruling 20's
  ...
  [Ruling 21](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)): styled **47.22% of valid =
  ...
  4.05 points.
- **STAGE 1B IS THE BANKED A0** ([Ruling 22](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)):
...
- **The gem is GARNET** (Director, 2026-08-08, one word —
  [Ruling 23](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)): the fixture holds; the stone's
...
- **The lane ran to acceptance and the arc CLOSED at Ruling 35.** The stroke
  lane was ruled at HALT 1 ([Ruling 24](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md): eight
  ...
  [Ruling 33](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)); **the ingest** — dataset asset
  ...
  five ingests** ([Ruling 34](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)); and **the polish
  arc CHARTERED** ([Ruling 35](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)): every accepted
...
[known defects](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/known-defects.md).
...
([E14 Ruling 9](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E14-ruling.md)): the population is the bake-margin
...
([E10-offsurface-ruling.md](https://github.com/mcp-tool-shop-org/facet/blob/main/docs/experiments/E10-offsurface-ruling.md) Ruling 7c).
