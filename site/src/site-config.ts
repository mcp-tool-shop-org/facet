      ...
      features: [
        {
          ...
          desc: 'Every non-trivial change runs as a numbered experiment. The session that designs an experiment does not grade its results, and the session that runs it does not decide what they mean. Seventy experiments are in the record, each with its predictions stated before the measurement.',
        },
        {
