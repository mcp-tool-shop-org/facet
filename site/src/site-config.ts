      ...
      features: [
        {
          ...
          desc: 'Every non-trivial change runs as a numbered experiment. The session that designs an experiment does not grade its results, and the session that runs it does not decide what they mean. Sixty-seven experiments are in the record, each with its predictions stated before the measurement.',
        },
        {
        ...
        },
        {
          ...
          desc: '1342 tests passing at two seats’ hands, with paths-gated CI on the 1288 hermetic ones. A commit that changes tool code carries tests for that code in the same commit; recorded anchors are ported into the harness rather than left in reports.',
        },
      ],
    },
    {
