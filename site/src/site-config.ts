    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          desc: '1040 tests passing at two seats’ hands, with paths-gated CI on the 995 hermetic ones. A commit that changes tool code carries tests for that code in the same commit; recorded anchors are ported into the harness rather than left in reports.',
        },
      ],
    },
    {
