...
- **Spec before the work, report after, ruling last** — and the session that designs an
  experiment never grades its own results. Thirty-six experiments are in
...
| **[The record](docs/experiments/)** | thirty-six experiments: spec, report, ruling, and every prediction stated before the measurement |
