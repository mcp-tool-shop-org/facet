...
- **Spec before the work, report after, ruling last** — and the session that designs an
  experiment never grades its own results. Fifty-nine experiments are in
...
| **[The record](docs/experiments/)** | fifty-nine experiments: spec, report, ruling, and every prediction stated before the measurement |
