...
- **Spec before the work, report after, ruling last** — and the session that designs an
  experiment never grades its own results. Sixty-five experiments are in
...
| **[The record](docs/experiments/)** | sixty-five experiments: spec, report, ruling, and every prediction stated before the measurement |
