...
- **I test vengono eseguiti insieme alla modifica del codice**; 1002 test hanno avuto esito positivo grazie al lavoro di due persone, con una pipeline CI basata su percorsi per i 957 test più importanti.
