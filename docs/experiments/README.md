...
| [E06](E06-cull-the-unseeable.md) | Does culling exterior-invisible faces before unwrapping fix coverage, atlas efficiency and the artifact mechanism together? | **SPEC — highest priority.** E03 and E04 wait on it |
