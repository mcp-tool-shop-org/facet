...
| the record | four-leg verify SERVING at close, byte-identity, over 65 experiments. No staleness findings at the declaration leg — recertify with MCP `record_build` after any doc change. 415 corpus files; `paid_for_by` reports 0 unrecognised |
