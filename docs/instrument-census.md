...
| — files of any other extension there | 0 |
| **total members** | **112** |
| corpus files read for axis D | 312 |
...
| 111 | `tree_manifest.py` | verify | yes | 7 | no | 6 | yes | yes | none | Protection manifests for the read-only trees: verify one, or emit a new one. |
