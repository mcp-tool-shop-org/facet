...
| longsword (Prop — handheld) | **ultra-realistic** | **NONE** (Director, 2026-08-07: "Ultra-realistic, no LoRA" — E14 Ruling 5) | designated 00001 same day ("00001 is my favorite"); register decided day one per this table's law — chosen fresh, not inherited from the beast; fixture authored under it from birth |
